export const CHANCE_CARDS = {
  ...
  4: { title: "Caught Bunking", message: "Go directly to Fail.", type: "move_absolute", position: 10, inJail: true },
  ...
  10: { title: "Engifest", message: "Advance to Concert Ground.", type: "move_absolute", position: 39 },
...
export const CHEST_CARDS = {
  ...
  3: { title: "Pocket Money", message: "Pocket money arrived! Collect M200.", type: "collect", amount: 200 },
  4: { title: "Health Centre", message: "Doctor's fee. Pay M50.", type: "pay", amount: 50 },
  5: { title: "Yard Sale", message: "Yard sale of old items. Collect M50.", type: "collect", amount: 50 },
  6: { title: "UFM! Caught Cheating", message: "Go to Fail.", type: "move_absolute", position: 10, inJail: true },
  7: { title: "Holiday Fund", message: "Holiday fund matures. Collect M100.", type: "collect", amount: 100 },
  8: { title: "Mess Refund", message: "Mess fee refund. Collect M20.", type: "collect", amount: 20 },
  9: { title: "Birthday", message: "It is your birthday. Collect M10 from every player.", type: "collect_all", amount: 10 },
  10: { title: "Won a Bet", message: "Won a bet! Collect M100.", type: "collect", amount: 100 },
  11: { title: "Became the CR", message: "Party treat for the class! Pay M100.", type: "pay", amount: 100 },
